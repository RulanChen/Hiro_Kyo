...
Quintus.Sprites = function(Q) {
  ...
  */
  ...
  /**
   Create a number of `Q.SpriteSheet` objects from an images asset and a sprite data JSON asset
 ...
 Q._generateCollisionPoints = function(obj) {
  ...
  /**
   ...
   Auto sets the width and height (`p.w` and `p.h`) from the provided images asset and
   centers the sprite so 0,0 is the center of the provide images.
